            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{ route('soal008.create') }}" class="btn btn-primary pull-right">Tambah</a>
                    </div>
                    <div class="card-body">
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ ++$i }}</td>
                                    <td>{{ $row->nosoal008 }}</td>
                                    <td>{{ $row->pertanyaan008 }}</td>
                                    <td>{{ $row->jawaban008 }}</td>
                                    <td><a href="{{ route('soal008.edit', $row->id) }}" class="btn btn-primary">Edit</a></td>
                                    <td>
                                        <form action="{{ route('soal008.destroy', $row->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
